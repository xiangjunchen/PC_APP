...
#define  TP_RES_ARTICLE             0x00000001
#define  TP_RES_COLUMN				0x00000002
...
#define  TP_COLUMN_TYPE              ULONGLONG
#define  TP_COLUMN_UNKNOW			0x00000000
#define  TP_COLUMN_TECH				0x00000001
#define  TP_COLUMN_SPORT			0x00000002
...
typedef struct _tagTPColumnData : public TPResBaseInfo
{
	TP_COLUMN_TYPE		eColumnType;
	_tagTPColumnData()
	{
		Reset();
	}
	void Reset()
	{
		eResType	= TP_RES_COLUMN;
		eColumnType = TP_COLUMN_UNKNOW;
	}
}TPColumnData;
