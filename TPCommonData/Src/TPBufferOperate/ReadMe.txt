========================================================================
    MICROSOFT 基础类库 : TPBufferOperate 项目概况
========================================================================


应用程序向导已为您创建了此 TPBufferOperate DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 TPBufferOperate DLL
的每个文件的内容摘要。

TPBufferOperate.vcproj
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 TPBufferOperate.pch
