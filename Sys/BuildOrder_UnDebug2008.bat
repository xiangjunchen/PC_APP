devenv ..\TPCommonCtrl\Src\TPCommonClass\TPCommonClass.vcproj /build "Unicode Debug"
devenv ..\TPCommonCtrl\Src\TPExtraCtrl\TPExtraCtrl2008.vcproj /build "Unicode Debug"
devenv ..\TPCommonCtrl\Src\TPCommonCtrl\TPCommonCtrl.vcproj /build "Unicode Debug"
